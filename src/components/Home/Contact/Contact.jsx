...
const Contact = () => {
    ...
    return (
        ...
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 text-center">Contact Us</h1>
            <div className="container px-5 pt-10 pb-24 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-3/5 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe width="100%" height="100%" className="absolute inset-0" frameBorder="1" title="map" marginHeight="0" marginWidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6147.766491223612!2d90.49727451925635!3d23.622838025140638!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b108bc277e05%3A0xbab5a600cae0175b!2sChashara%20Station!5e0!3m2!1sen!2sbd!4v1624530021624!5m2!1sen!2sbd" style={iframeStyle}></iframe>
                    <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
                            <p className="mt-1">Narayanganj Hwy, Narayanganj 1400</p>
                        </div>
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                            <a className="text-green-500 leading-relaxed">habibullahbahar.piash@gmail.com</a>
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                            <p className="leading-relaxed">+8801857489911</p>
                        </div>
                    </div>
                </div>
                <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Send us message</h2>
                    <p className="leading-relaxed mb-5 text-gray-600">You can send us your message or feedback.</p>
