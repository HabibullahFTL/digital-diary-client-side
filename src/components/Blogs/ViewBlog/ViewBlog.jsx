            ...
            <div className="container py-5 mx-auto  ">
                <div className="flex flex-col w-full mb-20">
                    <div className="w-4/5 border rounded p-10 m-auto">
                        ...
                        <h1 className="sm:text-3xl text-2xl font-medium title-font my-4 text-gray-900">{blogInfo?.title}</h1>
                        <p className="py-3">{blogInfo?.description}</p>
                        <div className="mt-8 border border-gray-200 p-6 rounded-lg">
                            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-green-100 text-green-500 mb-4">
                                <img src={hb} alt="" />
                            </div>
                            <p>Author</p>
                            <h2 className="text-lg text-gray-900 font-medium title-font mb-2">{blogInfo?.createdBy?.displayName}</h2>
                        </div>
                    </div>
